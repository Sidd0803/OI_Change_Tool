...
FLEX trades don't have usable open interest on Bloomberg, so this is a separate pipeline that sources OI from OCC's daily Flex Open Interest reports instead.
